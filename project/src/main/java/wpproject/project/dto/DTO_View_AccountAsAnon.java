...
public class DTO_View_AccountAsAnon {
    ...
    public DTO_View_AccountAsAnon(Long id, String firstName, String lastName, String username, String mailAddress, LocalDate dateOfBirth, String profilePicture, String description, Account_Role accountRole, List<Shelf> shelves) {
        this.id = id;
